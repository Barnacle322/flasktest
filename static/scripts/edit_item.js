...
const enableDarkMode = () => {
    ...
    var description_input = document.getElementsByClassName('quantity_input')[0];
    description_input.classList.add("quantity_input_dark");

    var address_input = document.getElementsByClassName('price_input')[0];
    address_input.classList.add("price_input_dark");
...
const disableDarkMode = () => {
    ...
    var description_input = document.getElementsByClassName('quantity_input')[0];
    description_input.classList.remove("quantity_input_dark");

    var address_input = document.getElementsByClassName('price_input')[0];
    address_input.classList.remove("price_input_dark");
    // var login = document.getElementsByClassName('login')[0];
