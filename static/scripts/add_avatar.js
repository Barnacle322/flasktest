...
const enableDarkMode = () => {
    ...
    add_photo.classList.add("photo_add_screen_dark");
    var v9_31 = document.getElementsByClassName('v9_31')[0];
    v9_31.classList.add("v9_31_dark");
    var photo_input = document.getElementsByClassName('photo_input')[0];
    photo_input.classList.add("photo_input_dark");
...
const disableDarkMode = () => {
    ...
    var photo_input = document.getElementsByClassName('photo_input')[0];
    photo_input.classList.remove("photo_input_dark");
    var login = document.getElementsByClassName('login')[0];
